                            ...
                            <div class="row mb-2">
                                <div class="col-md-5">
                                    ...
                                    <div class="row col-md-12 mt-2">
                                        <div class="custom-control custom-checkbox col-md-4">
                                            <input type="checkbox" class="custom-control-input" id="cbxNew" checked="true">
                                ...
                                <div class="col-md-7">
                                    ...
                                    <div class="row col-md-12 input-search">
                                        <input class="form-control col-md-9" type="text" placeholder="Title or keyword..." aria-label="Search" aria-describedby="basic-addon2" />
                            ...
                            <table class="table table-bordered">
                                <thead>
                                    <tr>
                                        ...
                                        <th>Date</th>
                                        <th>Status</th>
                                        <th style="width: 350px">Descriptions</th>
                                        <th>Action</th>
                                    </tr>
                                </thead>
                                <tbody>
